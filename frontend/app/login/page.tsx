...
import { ArrowLeft, Mail, Lock, Github, Twitter, AlertCircle } from 'lucide-react'
    ...
    <main className="min-h-screen bg-black text-white flex items-center justify-center px-8 py-20">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="space-y-2">
          ...
          <p className="text-gray-400">Access your SimulationAI dashboard</p>
        </div>
            ...
            onClick={async () => {
              try {
                ...
                if (response.status === 503) {
                  setError('GitHub OAuth is not configured. Please use email/password login or contact administrator.')
                  return
                }
                window.location.href = `${apiUrl}/api/auth/github`
              } catch (err) {
                setError('Failed to initiate GitHub login. Please try email/password login.')
              }
            }}
          ...
          <button
            ...
            onClick={async () => {
              try {
                ...
                setError('Failed to initiate Google login. Please try email/password login.')
              }
            }}
            className="flex items-center justify-center gap-2 px-4 py-3 border border-gray-800 rounded-lg hover:bg-gray-900 transition-colors"
          >
        ...
        <button
          ...
          onClick={async () => {
            ...
            try {
              ...
              setError(e?.message || 'MetaMask login failed. Please try again.')
            } finally {
